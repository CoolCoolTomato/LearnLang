...
var developerWritableFields = map[string]map[string]bool{
	...
	DeveloperResourceConversationArchives: {"user_id": true, "start_message_id": true, "end_message_id": true, "message_ids": true, "summary": true, "message_count": true, "embedding_id": true},
